...
export const LeadDetailsModal: React.FC<LeadDetailsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[100] p-4 pt-[calc(1rem+var(--safe-top))] pb-[calc(1rem+var(--safe-bottom))]">
      <motion.div 
        initial={{ scale: 0.9, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
        className="bg-white rounded-[32px] p-0 max-w-2xl w-full shadow-2xl overflow-hidden flex flex-col max-h-[calc(var(--app-height)-var(--safe-top)-var(--safe-bottom)-2rem)]"
      >
        {/* Modal Header */}
        ...
        {/* Modal Footer */}
        <div className="p-6 pb-[calc(1.5rem+var(--safe-bottom))] bg-gray-50 border-t border-gray-100 flex gap-4 shrink-0">
          <button 
            onClick={() => setDetailsModal(null)}
