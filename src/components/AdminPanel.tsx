...
export const AdminPanel: React.FC<AdminPanelProps> = ({ profile, onLogout }) => {
  const admin = useAdmin(profile);
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);

  if (admin.isLoading) {
    return (
      <div className="min-h-app flex items-center justify-center bg-[#F5F5F0]">
  ...
  return (
    <div className="h-full bg-[#F5F5F0] flex flex-col lg:flex-row overflow-hidden">
      ...
      <main className="flex-1 p-4 md:p-8 lg:p-12 pb-[calc(1rem+var(--safe-bottom))] overflow-y-auto">
